Public NotInheritable Class About_MP_CNC_Calc

    Private Sub About_MP_CNC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
